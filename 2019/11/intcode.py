...
class IntCode:
    ...
    def _parse_arguments(self, argument_num):
        print("Get value at " + str(self.pc) + ": " + str(self.program[self.pc]) + " (line 86)")
        print("Get value at " + str(self.pc) + ": " + str(self.program[self.pc]) + " (line 87)")
        ...
        for i in range(argument_num):
            ...
            if modes[i] == '1':
                print("Get value at " + str(self.pc+i+1) + ": " + str(self.program[self.pc+i+1]) + " (line 93)")
                arguments.append(Argument(value, value))
            else:
                print("Get value at " + str(value) + ": " + str(self.program[value] if value < len(self.program) else self.memory.get(value, 0)) + " (line 96)")
    ...
    def set(self, address, value):
        print("Set value " + str(value) + " at index " + str(address))
